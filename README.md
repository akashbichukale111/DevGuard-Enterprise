...
[![Tests](https://img.shields.io/badge/tests-915%20passing-brightgreen.svg)](tests/)
...
make test      # 915 tests — no key, no collector, no network
...
**Engineering**
- 915 tests running in CI on every push with no key, no collector and no network
