...
[![Tests](https://img.shields.io/badge/tests-940%20passing-brightgreen.svg)](tests/)
...
make test      # 940 tests — no key, no collector, no network
...
**Engineering**
- 940 tests running in CI on every push with no key, no collector and no network
