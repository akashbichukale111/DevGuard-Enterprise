...
[![Tests](https://img.shields.io/badge/tests-882%20passing-brightgreen.svg)](tests/)
...
make test      # 882 tests — no key, no collector, no network
...
**Engineering**
- 882 tests running in CI on every push with no key, no collector and no network
