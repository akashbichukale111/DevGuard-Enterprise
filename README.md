...
[![Tests](https://img.shields.io/badge/tests-944%20passing-brightgreen.svg)](tests/)
...
make test      # 944 tests — no key, no collector, no network
...
**Engineering**
- 944 tests running in CI on every push with no key, no collector and no network
