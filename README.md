...
[![Tests](https://img.shields.io/badge/tests-998%20passing-brightgreen.svg)](tests/)
...
make test      # 998 tests — no key, no collector, no network
...
**Engineering**
- 998 tests running in CI on every push with no key, no collector and no network
