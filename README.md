...
[![Tests](https://img.shields.io/badge/tests-985%20passing-brightgreen.svg)](tests/)
...
make test      # 985 tests — no key, no collector, no network
...
**Engineering**
- 985 tests running in CI on every push with no key, no collector and no network
