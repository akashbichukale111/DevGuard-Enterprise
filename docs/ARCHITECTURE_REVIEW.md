...
**Scale now:** 30,537 lines of Python across 117 files · 8,769 lines of TypeScript across 31 files · 1101 tests.
...
| Reproducibility from clean clone | **Satisfied** | Verified; 1101 tests, no key needed |
