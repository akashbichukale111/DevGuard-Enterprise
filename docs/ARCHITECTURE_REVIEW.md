...
**Scale:** 25,596 lines of Python across 94 files · 8,729 lines of TypeScript across 30 files · 775 tests.
...
| Reproducibility from clean clone | **Satisfied** | Verified; 775 tests, no key needed |
