...
**Scale now:** 27,514 lines of Python across 105 files · 8,769 lines of TypeScript across 31 files · 985 tests.
...
| Reproducibility from clean clone | **Satisfied** | Verified; 985 tests, no key needed |
